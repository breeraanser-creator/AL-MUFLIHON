    ...
    if (email) {
      dispatch(
        showToast({
          type: 'success',
          message:
            'JazakAllah Khair! You have subscribed to AL-MUFLIHON VIP releases.'
        })
      );
    ...
    <footer className="bg-brand-plum text-brand-cream border-t-4 border-brand-rose">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center md:text-left">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-brand-cream/70">
                100% pure Egyptian cotton & linen
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-brand-cream/70">
                7 days hassle-free sizing exchange
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-brand-cream/80 leading-relaxed font-light pr-4">
              "Those who succeed" — AL-MUFLIHON is dedicated to redefining
              modern modest fashion. We curate premium Saudi thobes, bespoke
              kurtas, flowing abayas, and Kashmiri shawls crafted with spiritual
              reverence and timeless sartorial excellence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-brand-cream/80">
              ...
              <li>
                <Link
                  to="/shop?category=Kurta Collection"
              ...
              <li>
                <Link
                  to="/shop?category=Stitched Collection"
                  className="hover:text-brand-rose transition-colors"
                >
                  Stitched Collection
                </Link>
              ...
              <li>
                <Link
                  to="/shop?category=Unstitched Collection"
                  className="hover:text-brand-rose transition-colors"
                >
              ...
              <li>
                <Link
                  to="/shop?category=Summer Collection"
                  className="hover:text-brand-rose transition-colors"
                >
                  Summer Collection
                </Link>
              ...
              <li>
                <Link
                  to="/shop?category=Winter Collection"
                  className="hover:text-brand-rose transition-colors"
                >
                  Winter Collection
                </Link>
              ...
              <li>
                <Link
                  to="/shop?category=Luxury Shawls"
                  className="hover:text-brand-rose transition-colors"
                >
                  Handwoven Shawls
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-brand-cream/80">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a
                  href="tel:03294377954"
                  className="hover:text-brand-rose transition-colors font-semibold"
                >
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a
                  href="mailto:admin@almuflihon.com"
                  className="hover:text-brand-rose transition-colors"
                >
        ...
        <div className="border-t border-brand-rose/20 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-brand-cream/60 gap-4">
          ...
          <p>
            © {new Date().getFullYear()} AL-MUFLIHON Clothing Brand.
            All Rights Reserved. (المفلحون)
          </p>

          <div className="flex items-center space-x-6">

            <span className="hover:text-brand-cream cursor-pointer">
              Privacy Policy
            </span>
